      ...
      <div className="mt-2 d-flex aligns-items-center justify-content-center">
        ...
        >
          <div className="card-header bg-color text-center custom-bg-text">
            <h3 className="card-title">Ajouter une installation</h3>
          </div>
          <div className="card-body text-color">
            <form onSubmit={saveHotelFacility}>
              <div className="mb-3">
                ...
                >
                  <option value="">Choisir un équipemen</option>
            ...
            <div className="mt-5 text-center">
              <h3>Équipements sélectionnés de l'hôtel</h3>
            </div>
              ...
              <table className="table table-hover custom-bg-text text-center">
                <thead className="bg-color table-bordered border-color">
                  <tr>
                    ...
                    <th scope="col">Description de l'équipement</th>
