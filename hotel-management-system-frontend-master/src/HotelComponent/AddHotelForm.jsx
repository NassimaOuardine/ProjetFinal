      ...
      <div className="mt-2 d-flex aligns-items-center justify-content-center">
        ...
        >
          <div className="card-header bg-color custom-bg-text text-center">
            <h5 className="card-title">Ajouter un hôtel</h5>
          </div>
          <div className="card-body text-color">
            <form className="row g-3">
              ...
              <div className="col-md-6 mb-3">
                ...
                >
                  <option value="">
                    Sélectionner l'administrateur de l'hôtel
                  </option>
              ...
              <div className="col-md-6 mb-3">
                <label htmlFor="image1" className="form-label">
                  <b> Sélectionner l'image 1 de l'hôtel</b>
                </label>
                <input
                  className="form-control"
                  type="file"
              ...
              <div className="col-md-6 mb-3">
                <label htmlFor="image2" className="form-label">
                  <b> Sélectionner l'image 2 de l'hôtel</b>
                </label>
                <input
                  className="form-control"
                  type="file"
              ...
              <div className="col-md-6 mb-3">
                <label htmlFor="image3" className="form-label">
                  <b> Sélectionner l'image 3 de l'hôtel</b>
                </label>
                <input
                  className="form-control"
                  type="file"
